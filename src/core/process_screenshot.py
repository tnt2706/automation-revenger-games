...
TEMPLATE_THRESHOLDS = {
    "high": 0.85,  # High confidence - very reliable matches
    "medium": 0.70,  # Medium confidence - good matches
    "low": 0.55,  # Low confidence - potential matches
    "display_min": 0.50,  # Minimum threshold to display on screenshot
}
